            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-body">
                        ...
                        <h5 class="card-title">Trường Cao Đẳng Công Nghệ Thủ Đức</h5>
                        <p class="card-text">53 Võ Văn Ngân, Q.Thủ Đức, TP. HCM</p>
                        <p class="card-text">fashion.h.2025@gmail.com</p>
                    </div>
                </div>
            </div>
